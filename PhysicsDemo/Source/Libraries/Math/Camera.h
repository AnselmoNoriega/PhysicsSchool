...
namespace jm::math
{
	...
	{
		return perspective_projection_matrix3(vert_fov, aspect, 0.1f);
	}
	...
	matrix44<T> camera3<T>::get_orthogonal_transform() const
	{
		...
		return orthogonal_projection_matrix3(-farHalfSize.x, farHalfSize.x, -farHalfSize.y, farHalfSize.y, 0.001f, 1000.0f);
	}
}
